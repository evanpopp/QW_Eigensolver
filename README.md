...
1. Simulation Parameters:
    ...
    full: If you want to solve outside of the qw, select True
...
When executed, the script will:
    ...
    Render two plots:
        The spatial probability density/wavefunction of the selected eigenstate.
        The physical band diagram/potential well structure based on the applied bias and resolution.
